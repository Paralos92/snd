...
function MongoDBFunctions(opts) {
  ...
  function execute(command, options) {
    ...
    const streams = $os.runProgram($file.join(binDir, 'mongo'), commandArguments, {retrieveStdStreams: true});
  ...
  function executeFile(file, options) {
    ...
    return $os.runProgram($file.join(binDir, 'mongo'), commandArguments);
  }
